...
#define MQTT_CLIENT_ID        "flood_sensor_basement"
#define MQTT_TOPIC_PUB1       "flood_sensor_basement/state"
#define MQTT_TOPIC_PUB2       "flood_sensor_basement/batt_state"

#define MQTT_TOPIC_PUB1_STR1   "WATER_OFF"
